...
\begin{itemize}
	...
	\item $\limm \sqrt{n} (\sqrt{n + 2} - \sqrt{n}) \stackrel{\text{Wurzeltrick}}{=} \limm \frac{2 \sqrt{2}}{\sqrt{n + \sqrt{n}} + \sqrt{n - \sqrt{n}} }$ \\$ = \limm \frac{2 \sqrt{2}}{\sqrt{n} \sqrt{1 + \frac{1}{\sqrt{n}}} + \sqrt{n} \sqrt{1 - \frac{1}{\sqrt{n}}}} = 1$
\end{itemize}
